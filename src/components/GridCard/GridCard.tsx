...
export const GridCard = ({ size }: { size: CardSize }) => {
...
<Card
  ...
  className={`
    ...
    flex flex-col px-6 pt-6 pb-4 justify-start
  `}
>
  ...
  {/* Title */}
  <div className="relative z-10 w-full text-center mt-[clamp(20px,6vw,58px)] ">
