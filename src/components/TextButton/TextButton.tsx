...
const wrapperClass = `
    w-[15vw] max-w-[64px]        // Responsive width for the component
    aspect-square                // Ensures square
    rounded-[20px]             
    bg-white                    
    shadow-lg                    
  ...
  const baseStyles = `
    ...
    text-[clamp(24px,8vw,52px)]   // Min 24px, preferred 8vw, Max 52px
    leading-[1]                   // Line height 1 (100% of current font size)
    tracking-normal
    transition-colors
    cursor-pointer
  `;
